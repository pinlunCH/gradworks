...
<body>
	<div id="wrapper">
		<div class="allDept">
			...
			<div class="ani">
				<div class="animation">
					<h1>Visual effects for film & tv</h1><br>
					<p>Learn how to make visual effects for movies, television and web series in VanArts' one-year intensive program. Our instructors have worked on some of the industry's biggest blockbusters and will mentor you all of the way through the program.</p>
				</div>

				<div class="animationDept">
					<div class="animationArrowLeft">
						<a href="photography.html"><i class="fas fa-chevron-circle-left fa-3x"></i></i></a>
					</div>

					<div class="animationArrowRight">
						<a href="radio.html"><i class="fas fa-chevron-circle-right fa-3x"></i></i></a>
					</div>
